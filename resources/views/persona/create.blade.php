        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white">
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-light">
                    ...
                    <div>
                        <h5 class="fw-bold text-dark mb-0" style="letter-spacing: -0.5px;">Crear Nueva Persona</h5>
                        <small class="text-muted">Registro maestro para el catálogo general del sistema</small>
                    </div>
                </div>

                <form action="{{ url('personas') }}" method="post" id="formCreatePersona">
                    @csrf
                    
                    <div class="row">
                        {{-- Input: Nombre (Burbuja Azul Pastel) --}}
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group align-items-center">
                                ...
                                <input type="text" class="form-control bg-light border-0 rounded-end-3 py-2 text-dark fw-medium" id="nom" name="nom" placeholder="Ej: Juan" style="font-size: 14px; height: 42px;" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group align-items-center">
                                ...
                                <input type="text" class="form-control bg-light border-0 rounded-end-3 py-2 text-dark fw-medium" id="ap" name="ap" placeholder="Ej: Pérez" style="font-size: 14px; height: 42px;" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group align-items-center">
                                ...
                                <input type="text" class="form-control bg-light border-0 rounded-end-3 py-2 text-dark fw-medium" id="am" name="am" placeholder="Ej: García" style="font-size: 14px; height: 42px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group align-items-center">
                            ...
                            <input type="date" class="form-control bg-light border-0 rounded-end-3 py-2 text-dark fw-medium" id="fecha_nac" name="fecha_nac" style="font-size: 14px; height: 42px;" required>
                        </div>
                    </div>
...
<script>
    document.getElementById('formCreatePersona').addEventListener('submit', function(e) {
        e.preventDefault(); // Detener el envío automático para procesar las validaciones
        ...
        // Mezcla de botones con tus clases estables de Bootstrap
        ...
        // 1. VALIDACIÓN LÓGICA: Nombre, Apellido Paterno y Fecha requeridos
        if (!nomInput || !apInput || !fechaInput) {
            swalWithBootstrapButtons.fire({
                title: "Campos Incompletos",
                text: "Por favor, el nombre, el apellido paterno y la fecha de nacimiento son obligatorios.",
                icon: "warning",
        ...
        swalWithBootstrapButtons.fire({
            title: "¿Registrar esta persona?",
            text: `Vas a dar de alta a: "${nomInput} ${apInput} ${amInput}". Asegúrate de verificar que los datos sean correctos antes de continuar.`,
            icon: "question",
            ...
            if (result.isConfirmed) {
                ...
                swalWithBootstrapButtons.fire({
                    title: "Cancelado",
                    text: "No se ha generado ningún registro nuevo.",
                    icon: "info",
